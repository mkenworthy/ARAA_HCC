...
$\vec{E}$ & Electric field & $\vec{H}$ & Magnetic field \\\hline
$\mathcal{D}$ & Displacement field & $\mathcal{B}$ & Magnetizing field \\\hline
$\epsilon$ & Electric permittivity & $\epsilon_0$ & Electric permittivity of vacuum \\\hline
$\mu$ & Magnetic permittivity & $\mu_0$ & Magnetic permittivity of vacuum \\\hline
$\omega$ & Wavenumber & $\vec{k}$ & Wavevector \\\hline
$\lambda$ & Wavelength & $\lambda_0$ & Center wavelength in the bandpass \\\hline
